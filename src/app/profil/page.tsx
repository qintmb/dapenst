  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-12">
        <div className="bg-container-grey dark:bg-gray-800 rounded-lg shadow-md p-6 md:p-8 mb-12 animate-on-scroll opacity-0">
          ...
          <div className="prose max-w-none text-foreground">
            <p className="mb-4 animate-on-scroll opacity-0">
              Dana Pensiun Semen Tonasa didirikan pada tahun 2003 sebagai bagian dari komitmen PT Semen Tonasa 
              terhadap kesejahteraan karyawan pensiun. Sejak awal berdiri, kami telah berfokus pada pengelolaan 
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
          <div className="bg-container-grey dark:bg-gray-800 rounded-lg shadow-md p-6 md:p-8 animate-on-scroll opacity-0">
            <h3 className="text-xl font-bold mb-4 text-foreground">Visi & Misi</h3>
          ...
          <div className="bg-container-grey dark:bg-gray-800 rounded-lg shadow-md p-6 md:p-8 animate-on-scroll opacity-0 delay-100">
            <h3 className="text-xl font-bold mb-4 text-foreground">Nilai-Nilai Perusahaan</h3>
            <div className="space-y-4">
        ...
        <div className="bg-container-grey dark:bg-gray-800 rounded-lg shadow-md p-6 md:p-8 animate-on-scroll opacity-0">
          <h2 className="text-2xl font-bold mb-6 text-foreground">Struktur Organisasi</h2>
