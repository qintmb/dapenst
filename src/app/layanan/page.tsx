      ...
      <main className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          <div className="bg-container-grey dark:bg-gray-800 rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-all duration-300 transform hover:-translate-y-2 animate-on-scroll opacity-0">
            ...
            <div className="p-6">
              <h3 className="text-white text-xl font-bold mb-2 text-foreground">Program Pensiun Pokok</h3>
              <p className="text-secondary mb-4">
                Program pensiun dasar yang memberikan penghasilan tetap setiap bulan setelah masa pensiun tiba.
              </p>
              <button className="text-primary hover:text-red-700 flex items-center transition-all duration-300 group">
                Selengkapnya
          ...
          <div className="bg-container-grey dark:bg-gray-800 rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-all duration-300 transform hover:-translate-y-2 animate-on-scroll opacity-0 delay-100">
            <div className="bg-gray-200 border-2 border-dashed rounded-xl w-full h-48" />
            <div className="p-6">
              <h3 className="text-white text-xl font-bold mb-2 text-foreground">Program Pensiun Tambahan</h3>
              <p className="text-secondary mb-4">
          ...
          <div className="bg-container-grey dark:bg-gray-800 rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-all duration-300 transform hover:-translate-y-2 animate-on-scroll opacity-0 delay-200">
            <div className="bg-gray-200 border-2 border-dashed rounded-xl w-full h-48" />
            <div className="p-6">
              <h3 className="text-white text-xl font-bold mb-2 text-foreground">Program Dana Pensiun Manfaat Awal</h3>
              <p className="text-secondary mb-4">
        ...
        <div className="bg-soft-grey rounded-lg p-8 mb-16 animate-on-scroll opacity-0">
          <h2 className="text-3xl font-bold mb-10 text-foreground text-center">Pendaftaran Kepesertaan</h2>
        ...
        <div className="bg-container-grey rounded-lg shadow-md p-6 md:p-8 animate-on-scroll opacity-0">
          <h2 className="text-red-500 text-2xl font-bold mb-6 text-foreground">Syarat dan Ketentuan</h2>
          <div className="prose max-w-none text-foreground">
            <ul className="text-black list-disc pl-5 space-y-2 text-secondary">
              <li>Peserta adalah merupakan karyawan aktif PT Semen Tonasa</li>
